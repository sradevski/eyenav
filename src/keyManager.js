define(function(require, exports, module) {
	...
	//Note: This works only for 2 level objects such as mine, it is not flexible at all. As Brackets doesn't allow other libraries, I cannot use lodash or similar, so this solution is enough.
