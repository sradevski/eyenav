...
define(function (require, exports, module) {
  ...
  var getCharSize = function(){
    ...
    return {width: charWidth, height: rowHeight};
  };
  ...
  var getCursorCoords = function(){
    ...
    var cursorCoords = {x: cursorPos.ch * charSize.width, y: cursorPos.line * charSize.height};
  ...
  var getNumOfLines = function(){
    var curEditor = EditorManager.getCurrentFullEditor();
    var charSize = getCharSize();
    //ToDo: Figure out where the 30 pixels come from (which variable)
